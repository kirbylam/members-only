...
class UserTest < ActiveSupport::TestCase
  ...
  test "more than 12 name" do
    mt12_user = User.new("username": "johndoe123456", "email": v_email, "password": v_pw)
  ...
  test "less than 6 password" do
    lt6_password = User.new("username": v_name, "email": v_email, "password": "12345")
  ...
  test "existing username" do
    dupe_name = User.new("username": "joesmith", "email": v_email, "password": v_pw)
    assert_not dupe_name.valid?
  end

  # test to check if a user with an existing email in the db is not valid
  test "existing email" do
    dupe_email = User.new("username": v_name, "email": "coolkid@gmail.com", "password": v_pw)
